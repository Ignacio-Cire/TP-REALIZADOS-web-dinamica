...
<body>
    ...
    if ($verifica) {
        ...
        echo "<h1 style='color: #ffff00; background-color: #000;'>Sos menor de edad, no pasas!!.</h1>";
    }
    ?>

    <!-- Enlace para volver al formulario -->
    <a href="form-get.html" style='color: #ffff00; background-color: #000;'>Volver al formulario</a>
</body>
</html>
